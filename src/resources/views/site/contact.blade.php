        ...
        <div class="container">
            <div class="row mt-5 mb-5">
                ...
                <div class="col-lg-6">
                    ...
                    <form method="POST" action="{{ route('contacts.sendEmail') }}">
                        @csrf

                        <div class="form-group">
                            <input type="text" name="name" class="form-control underline-input" placeholder="Nome"
                        ...
                        <div class="form-group">
                            <textarea name="message" class="form-control underline-input" rows="2" placeholder="Descrição"
                    ...
                    @foreach ($contactsinfo as $info)
                        <div class="contact-item">
                            ...
                            <div class="d-flex w-100 fw-bold">
                                <div class="contact-label">{{ $info->type }}</div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-start ">
                    ...
                    <button class="btn btn-cta">
                        <a href="#contacto" style="color: white; text-decoration: none; hover: #E60073;">Contacte-nos</a> <i
