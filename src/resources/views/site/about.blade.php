        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <p class="about-text">É só você ter determinado algoritmo respeitar nosso discurso, validade sequência trabalho aceitei ser assunto político.</p>
                    <p class="about-text">É só você ter determinado algoritmo respeitar nosso discurso, validade sequência trabalho aceitei ser assunto político.</p>
                </div>
                <div class="col-md-6 mb-4">
                    <p class="about-text">É só você ter determinado algoritmo respeitar nosso discurso, validade sequência trabalho aceitei ser assunto político.</p>
    ...
    >
        <div class="container">
            <div class="row align-items-centers ">
                <div class="col-lg-6 ">
                    <img src="assets/img/pic-didi-sentada.jpg" alt="Team meeting" class="stats-image img-fluid rounded">
                </div>
                <div class="col-lg-6 ps-lg-5 ">
                    <div class="row py-3">
                        <div class="col d-flex justify-content-between ">
                            
                            <span class="stat-number px-3">237+</span>
                            <div class="col">
                                <h3 class="stat-title">Projectos Sociais</h3>
                            <p class="stat-description">É só você ter determinado algoritmo respeitar nosso discurso, validade sequência trabalho aceitei ser</p> 
                             <hr>
                            </div>
                    ...
                    <div class="row py-3">
                        <div class="col d-flex justify-content-between ">
                            <span class="stat-number px-3">109+</span>
                            <div class="col">
                                <h3 class="stat-title">Prémios</h3>
                            <p class="stat-description">É só você ter determinado algoritmo respeitar nosso discurso, validade sequência trabalho aceitei ser</p>  
                            <hr>
                            </div>
                        </div>
                    ...
                    <div class="row py-3">
                        <div class="col d-flex justify-content-between ">
                            <span class="stat-number px-3">766+</span>
                            <div class="col">
                                <h3 class="stat-title">Sonhos Realizados</h3>
                            <p class="stat-description">É só você ter determinado algoritmo respeitar nosso discurso, validade sequência trabalho aceitei ser</p>  
                            <hr>
                            </div>
                        </div>
      ...
      <div class="row mb-5 align-items-center">
        ...
        <div class="col-lg-10"> 
          <h2 class="fw-bold" style="font-size: 1.8rem; line-height: 1.3;">
            Nossas <span style="background: #FF00B4; color: white; padding: 0 6px;">soluções exclusivas</span> são adaptadas aos seus 
      ...
      <div class="row g-4">
        <div class="col-lg-4">
          <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 12px;">
            <img src="assets/img/pic-didi-sentada.jpg" alt="Visitas de Pessoas" class="w-100" style="height: 250px; object-fit: cover;">
        ...
        <div class="col-lg-4">
          <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 12px;">
            <img src="assets/img/pic-didi-sentada.jpg" alt="Oferta de Comida" class="w-100" style="height: 250px; object-fit: cover;">
            <div class="card-body text-center">
              <button class="btn btn-lg text-white w-100" style="background: #FF00B4; border-radius: 8px;">
                Oferta de Comida
              </button>
        ...
        <div class="col-lg-4">
          <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 12px;">
            <img src="assets/img/pic-didi-sentada.jpg" alt="Doação de Sopa" class="w-100" style="height: 250px; object-fit: cover;">
            <div class="card-body text-center">
              <button class="btn btn-lg text-white w-100" style="background: #FF00B4; border-radius: 8px;">
                Doação de Sopa
              </button>
    ...
    >
        <div class="container">
          ...
          <div class="row mb-5 align-items-center">
            ...
            <div class="col-lg-10">
              <h2 class="fw-bold" style="font-size: 1.8rem; line-height: 1.3;">
                Conheça todo o grupo de apoio à Worei, <span class="highlight-pink-text">composto por mulheres empoderadas</span>
              </h2>
            </div>
          </div>
          ...
          <div class="row g-4">
            <div class="col-md-4"> 
              <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 12px;">
                <img src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" class="w-100" style="height: 250px; object-fit: cover;">
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 12px;">
                <img src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" class="w-100" style="height: 250px; object-fit: cover;">
                <div class="card-body text-center ">
