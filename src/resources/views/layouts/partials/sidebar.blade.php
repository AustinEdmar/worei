<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer mt-auto pt-4 border-top">
        <div class="user-profile">
            <div class="user-avatar bg-secondary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
        ...
        <div class="logout px-2 mt-5">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-outline-danger bg-danger w-100 d-flex align-items-center justify-content-center gap-3 border-0 py-2">
