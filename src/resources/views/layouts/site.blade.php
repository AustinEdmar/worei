...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <li class="nav-item">
        <a class="nav-link {{ Route::is('site.about') ? 'active' : '' }}" href="{{ route('site.about') }}">SOBRE NÓS</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ Route::is('site.events') ? 'active' : '' }}" href="{{ route('site.events') }}">EVENTOS</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ Route::is('site.services') ? 'active' : '' }}" href="{{ route('site.services') }}">SERVIÇOS</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ Route::is('site.blog') ? 'active' : '' }}" href="{{ route('site.blog') }}">BLOG</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ Route::is('site.contacts') ? 'active' : '' }}" href="{{ route('site.contacts') }}">CONTACTOS</a>
    </li>
</ul>
            ...
            <div class="row text-center text-md-start">
                ...
                <div class="col-12 col-md-6 mb-4">
                    ...
                    <p class="text-secondary mb-0">
                        Empoderando mulheres e construindo um futuro mais igualitário através de ações transformadoras.
                    </p>
                </div>
